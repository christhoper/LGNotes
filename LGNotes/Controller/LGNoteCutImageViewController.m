...
@interface LGNoteCutImageViewController ()
/** 裁剪图片使用 */
@property (nonatomic, strong) TKImageView *cutImageView;
@property (nonatomic, strong) UIButton *sureBtn;
@property (nonatomic, strong) UIButton *cancelBtn;

@end

@implementation LGNoteCutImageViewController
...
#pragma mark - lazy
- (TKImageView *)cutImageView{
    if (!_cutImageView) {
        _cutImageView = [[TKImageView alloc] init];
        // 裁剪图片对象
