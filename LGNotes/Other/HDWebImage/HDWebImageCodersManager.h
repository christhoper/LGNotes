...
/**
 ...
 Coders
 ------
 A coder must conform to the `HDWebImageCoder` protocol or even to `HDWebImageProgressiveCoder` if it supports progressive decoding
 ...
 */
@interface HDWebImageCodersManager : NSObject<HDWebImageCoder>
 ...
 */
@property (nonatomic, copy, readwrite, nullable) NSArray<id<HDWebImageCoder>> *coders;
