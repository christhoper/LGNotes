...
@interface HDWebImageFrame : NSObject

// This class is used for creating animated images via `animatedImageWithFrames` in `HDWebImageCoderHelper`. Attention if you need to specify animated images loop count, use `HD_imageLoopCount` property in `UIImage+MultiFormat`.
