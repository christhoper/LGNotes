...
/**
 ...
 For a full GIF support, we recommend `FLAnimatedImage` or our less performant `HDWebImageGIFCoder`
 ...
 */
@interface HDWebImageImageIOCoder : NSObject <HDWebImageProgressiveCoder>
