...
@interface HDWebImageCoderHelper : NSObject
 ...
 */
+ (UIImage * _Nullable)animatedImageWithFrames:(NSArray<HDWebImageFrame *> * _Nullable)frames;
 ...
 */
+ (NSArray<HDWebImageFrame *> * _Nullable)framesFromAnimatedImage:(UIImage * _Nullable)animatedImage;
