 ...
 */
FOUNDATION_EXPORT NSString * _Nonnull const HDWebImageCoderScaleDownLargeImagesKey;
 ...
 */
CG_EXTERN CGColorSpaceRef _Nonnull HDCGColorSpaceGetDeviceRGB(void);
 ...
 */
CG_EXTERN BOOL HDCGImageRefContainsAlpha(_Nullable CGImageRef imageRef);
 ...
 */
@protocol HDWebImageCoder <NSObject>
...
/**
 ...
 @param optionsDict A dictionary containing any decompressing options. Pass {HDWebImageCoderScaleDownLargeImagesKey: @(YES)} to scale down large images
...
/**
 ...
 @param format The image format to encode, you should note `HDImageFormatUndefined` format is also  possible
 @return The encoded image data
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image format:(HDImageFormat)format;
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol HDWebImageProgressiveCoder <HDWebImageCoder>
