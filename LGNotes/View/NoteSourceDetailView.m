...
@interface NoteSourceDetailView () <WKNavigationDelegate,WKUIDelegate>
...
@implementation NoteSourceDetailView

- (void)dealloc{
    NSLog(@"NoteSourceDetailView释放了");
}

+ (NoteSourceDetailView *)showSourceDatailView{
    NoteSourceDetailView *detailView = [[NoteSourceDetailView alloc] init];
