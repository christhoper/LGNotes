...
@interface DrawBoardModel : LGNoteBaseModel

@property (nonatomic, assign) NSInteger modelType;

@end

@interface DrawBoardPointModel : DrawBoardModel
...
@interface DrawBoardBrushModel : DrawBoardModel
...
@interface DrawBoardActionModel : DrawBoardModel
...
@property (nonatomic, strong) NSMutableArray<DrawBoardModel*> *pointOrBrushArray;
