...
@implementation UITextView (LGExtension)
...
- (void)addImage:(UIImage *)image multiple:(CGFloat)miltiple{
    [self addImage:image size:CGSizeZero index:(self.attributedText.length > 0 ? self.attributedText.length:0) multiple:miltiple];
}
